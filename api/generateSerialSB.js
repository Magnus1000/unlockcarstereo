...
async function insertRecords(start, count) {
    const batchSize = 20000; // Adjust batch size based on your testing and Supabase limits
...
module.exports = async (req, res) => {
    cors(req, res, async () => {
        try {
            ...
            const totalRecords = parseInt(req.query.totalRecords) || 20000; // Adjust for testing
